...
int main(int argc, char* argv[])
{
   ...
   int n = atoi(argv[1]);
   // Generator to check random insertion and random remove asymptomtic runtime
   // Calls n/2 insertions then n/2 removes
   // Checks if random element was already added by adding again
   // Tests the average case of insertion and remove
